  ...
  <form class="m-t" role="form" method="POST" action="{{ route('login') }}">
    ...
    <div class="svgContainer">
      <div>
        <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
          ...
          <circle cx="100" cy="100" r="100" fill="#1ab369"/> <!--se sustituyo por el color "#a9ddf3"-->
          <g class="body">
          ...
          <g class="eyeL">
            <circle cx="85.5" cy="78.5" r="3.5" fill="#3a5e77"/><!--OJOS -->
            <circle cx="84" cy="76" r="1" fill="#fff"/><!--OJOS -->
          </g>
          <g class="eyeR">
    ...
    <div class="inputGroup inputGroup3">
      <button id="login" type="submit">Ingresa</button>
              ...
              <script type="text/javascript" src="login2/app.js">
              </script>
