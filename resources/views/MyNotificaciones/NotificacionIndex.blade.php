...
<div class="container">
    ...
    <div class="col-md-6 col-xl-12  text-right">
                                    ...
                                    <li>
                                     <div>
                                         ...
                                         Estado: {{ $value->estado}}
                                             ...
                                             <a class="data"  href="{{route('nueva-notificacion',$value->notificacion_id)}}">
                                               <i class="fa fa-eye" aria-hidden="true"></i></a>


                                             <a href="{{route('delete-noti',$value->notificacion_id)}}"><i class="fa fa-trash-o "></i></a>
